...
while(j<i):
    ...
    ship=browser.find_elements(By.XPATH,"//*[@class='button-title']")[-1]
    ...
    phone.send_keys(data[j][-2])
    country=browser.find_element(By.XPATH,"//*[@id='react-select-4-input']").send_keys("Ελλάδα")
    browser.find_element(By.XPATH,"//*[@id='react-select-4-input']").send_keys(Keys.RETURN)
    region=browser.find_element(By.XPATH,"//*[@id='react-select-5-input']").click()
    time.sleep(120)
    region=browser.find_element(By.XPATH,"//*[@id='react-select-5-input']").send_keys(data[j][-1])
    browser.find_element(By.XPATH,"//*[@id='react-select-5-input']").send_keys(Keys.RETURN)

    address=browser.find_element(By.XPATH,"//*[@name='address']").send_keys(data[j][4])
    city=browser.find_element(By.XPATH,"//*[@name='city']").send_keys("dddd")
    postcode=browser.find_element(By.XPATH,"//*[@name='postcode']").send_keys(data[j][5])
